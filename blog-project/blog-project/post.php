...
$postComments = array_filter(
    $allComments,
    function ($comment) use ($postId) {
...
<body>
    ...
    <main class="container">
            ...
            <?php if (!empty($post['media']) && is_array($post['media'])) { ?>
                <div class="post-media">
                    <?php foreach ($post['media'] as $mediaPath) { ?>
                        <img src="<?= htmlspecialchars($mediaPath) ?>" alt="Медиафайл">
                    <?php } ?>
                </div>
            <?php } ?>
        ...
        <section class="comments-section">
            <h3>🗯️ Комментарии (<?= count($postComments) ?>)</h3>
                ...
                <form method="POST" action="" class="comment-form">
                    ...
                    <div class="form-group">
                        ...
                        <textarea
                            ...
                            required
                            minlength="3"
                            placeholder="Введите ваш комментарий..."><?= isset($_POST['content']) ? $_POST['content'] : '' ?></textarea>
                    </div>
